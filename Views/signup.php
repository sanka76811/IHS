                ...
                <hr>
                    	<div class="default-form">
                            <form method="post">
                                ...
                                <button type="button" class="btn btn-primary btn-lg btn-block" style="margin-left: 40px;"><i class="fa fa-facebook" style="margin-right:10px;" aria-hidden="true"></i>Facebook</button>
                                <button type="button" class="btn btn-danger btn-lg btn-block" style="margin-left: 40px;"><i class="fa fa-google-plus" aria-hidden="true" style="margin-right:7px;margin-left: -17px;"></i>Google</button>
                                </div>
                                </div>
                                <br>
                                ...
                                <hr>
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <div class="group-inner">
                                            ...
                                            <input type="text" name="fname" value="" minlength="2" placeholder="First Name*" required> 
                                        </div>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <div class="group-inner">
                                            <input type="password" name="passwordc" id="passwordc" value="" placeholder="Confirm Password *" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <div class="group-inner">
                                            <input class="numeric" type="text" name="mobileno" id="mobileno" value="" minlength="10" 
...
<script type="text/javascript">
      $(document).ready(function(){
         ...
         $("#signupform").validate({
             ...
             messages: {
                passwordc: " Enter Confirm Password Same as Password",
                mobileno:"Enter valid phone number"
            },
